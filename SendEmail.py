...
def EnvioCorreo(Mensaje):
    message = Mail(
        ...
        #to_emails=['a.zapata@practisistemas.com', 's.barrero@practisistemas.com', 'j.correal@practisistemas.com', 'd.guecha@practisistemas.com', 'zapatasebastian306@gmail.com'],
